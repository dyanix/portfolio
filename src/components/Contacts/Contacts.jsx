  ...
  return (
    <div className="Contacts">
      ...
      <div className="ContactLinks">
        ...
        <a href="https://linkedin.com/in/dyanesh dhawale" target="blank">
        ...
        <span style={{fontSize:"30px"}}>&#8627;</span>
        <a href="https://www.instagram.com/mr_dyanix/" target="blank">
          <img align="center" src="https://img.icons8.com/fluent/48/000000/instagram-new.png" />
        </a>

        <h3 align="left">twitter:</h3>
        <span style={{fontSize:"30px"}}>&#8627;</span>
        <a href="https://twitter.com/dyanix dhawale" target="blank">
